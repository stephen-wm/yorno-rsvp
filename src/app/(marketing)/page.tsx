...
export default function Home() {
	return (
		...
		>
			<main
				className="flex w-full max-w-full flex-1 flex-col items-center
					justify-center bg-white px-16 py-32 dark:bg-black"
			>
				<div className="grid place-items-center gap-4 text-center">
					...
					<p
						className="w-full text-base text-balance text-muted-foreground
							lg:max-w-lg"
					>
						Currently under construction, visit the{' '}
						<Link
							className="font-medium text-zinc-900 underline
								decoration-transparent underline-offset-8 transition-all
								duration-150 hover:text-primary hover:decoration-primary
								hover:underline-offset-4 dark:text-white
