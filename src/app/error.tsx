			...
			<div className="flex max-w-md flex-col items-center gap-6">
				...
				<div className="flex flex-col gap-2">
					...
					<p className="text-sm/relaxed text-muted-foreground">
						An unexpected error occurred. The team has been notified. You can try again, if the
				...
				<div className="flex flex-col gap-3 sm:flex-row">
					<button
						className="inline-flex h-9 items-center justify-center rounded-md bg-primary px-6
					...
					<Link
						className="inline-flex h-9 items-center justify-center rounded-md border border-input
							bg-background px-6 text-sm font-medium shadow-sm transition-colors hover:bg-accent
							hover:text-accent-foreground focus-visible:ring-1 focus-visible:ring-ring
							focus-visible:outline-none"
						href="/"
					>
						Go home
