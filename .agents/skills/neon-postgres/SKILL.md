...
1. **Append `.md` to the URL** (simplest): [https://neon.com/docs/introduction/branching.md](https://neon.com/docs/introduction/branching.md)
...
Common doc URLs are organized in the topic links below. If you need a page not listed here, search the docs index: [https://neon.com/docs/llms.txt](https://neon.com/docs/llms.txt) — don't guess URLs.
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/what-is-neon.md](https://neon.com/docs/ai/skills/neon-postgres/references/what-is-neon.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/getting-started.md](https://neon.com/docs/ai/skills/neon-postgres/references/getting-started.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/connection-methods.md](https://neon.com/docs/ai/skills/neon-postgres/references/connection-methods.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-serverless.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-serverless.md)

### Neon JS SDK

Use this for combined Neon Auth + Data API workflows with PostgREST-style querying and typed client setup.

Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-js.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-js.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/devtools.md](https://neon.com/docs/ai/skills/neon-postgres/references/devtools.md)

### Neon CLI

Use this for terminal-first workflows, scripts, and CI/CD automation with `neonctl`.

Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-cli.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-cli.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-rest-api.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-rest-api.md)

### Neon TypeScript SDK

Use this when implementing typed programmatic control of Neon resources in TypeScript via `@neondatabase/api-client`.

Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-typescript-sdk.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-typescript-sdk.md)

### Neon Python SDK

Use this when implementing programmatic Neon management in Python with the `neon-api` package.

Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-python-sdk.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-python-sdk.md)
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/neon-auth.md](https://neon.com/docs/ai/skills/neon-postgres/references/neon-auth.md)

Neon Auth is also embedded in the Neon JS SDK - so depending on your use case, you may want to use the Neon JS SDK instead of Neon Auth. See [https://neon.com/docs/ai/skills/neon-postgres/references/connection-methods.md](https://neon.com/docs/ai/skills/neon-postgres/references/connection-methods.md) for more details.
...
Link: [https://neon.com/docs/ai/skills/neon-postgres/references/branching.md](https://neon.com/docs/ai/skills/neon-postgres/references/branching.md)

## Autoscaling

Use this when the user needs compute to scale automatically with workload and wants guidance on CU sizing and runtime behavior.

Link: [https://neon.com/docs/introduction/autoscaling.md](https://neon.com/docs/introduction/autoscaling.md)
...
Link: [https://neon.com/docs/introduction/scale-to-zero.md](https://neon.com/docs/introduction/scale-to-zero.md)
...
Link: [https://neon.com/docs/introduction/branch-restore.md](https://neon.com/docs/introduction/branch-restore.md)
...
Link: [https://neon.com/docs/introduction/read-replicas.md](https://neon.com/docs/introduction/read-replicas.md)
...
Link: [https://neon.com/docs/connect/connection-pooling.md](https://neon.com/docs/connect/connection-pooling.md)

## IP Allow Lists

Use this when the user needs to restrict database access by trusted networks, IPs, or CIDR ranges.

Link: [https://neon.com/docs/introduction/ip-allow.md](https://neon.com/docs/introduction/ip-allow.md)
...
Link: [https://neon.com/docs/guides/logical-replication-guide.md](https://neon.com/docs/guides/logical-replication-guide.md)
